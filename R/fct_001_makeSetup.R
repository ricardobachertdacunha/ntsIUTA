...
#' @param title A character string with the project title. The default is \code{NA_character_}.
#' @param description A character string with the project description. The default is \code{NA_character_}.
