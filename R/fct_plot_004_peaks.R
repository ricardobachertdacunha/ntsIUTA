...
#'
#' @param eic A data table with the sample, replicate,
...
#' \code{"samples"} or \code{replicates},
#' for colouring by target peaks, samples or replicates, respectively.
#'
...
#'
#' @description Method for plotting peak spaces from a \linkS4class{ntsData} object.
#'
